                                ...
                                <table width="100%" class="table table table-striped table-bordered table-hover" id="dataTables">
                                    ...
                                    $i = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                              <a href="<?php echo base_url();?>admin/doctor/Schedule_controller/schedul_edit/<?php echo $value->schedul_id;?>" class="btn btn-xs btn-info">
                                                <i class="fa fa-edit"></i></a>
                                                <a href="<?php echo base_url();?>admin/doctor/Schedule_controller/schedul_delete/<?php echo $value->schedul_id;?>" class="btn btn-xs btn-danger">
