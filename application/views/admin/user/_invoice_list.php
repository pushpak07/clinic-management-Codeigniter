            ...
            <div class="col-sm-12">
                    <div class="panel panel-bd thumbnail">
                        ...
                        <div class="panel-heading no-print">
                            <div class="btn-group"> 
                                <a class="btn btn-success" href="<?php echo base_url();?>admin/user/Invoice"> <i class="fa fa-plus"></i>  Add Invoice </a>  
                            </div>
                        </div> 
                                ...
                                <tbody> 
                                    <?php $i=1; foreach($invo as $value){?> 
                                        <tr >
                                            ...
                                            <td class="center">
                                                <a href="<?php echo base_url();?>admin/user/Invoice/invoice_view/<?php echo $value->invoice_id;?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                                <a href="<?php echo base_url();?>admin/user/Invoice/edit_invoice/<?php echo $value->invoice_id;?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                                <a href="<?php echo base_url();?>admin/user/Invoice/delete/<?php echo $value->invoice_id;?>" onclick="return confirm('Are You Sure ? ')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a> 
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
