                                ...
                                ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if(empty($result) AND $this->session->userdata('user_type')==1) { ?>
                                            <a class="btn btn-xs btn-primary"  href="<?php echo base_url();?>admin/Prescription_controller/create_prescription/<?php echo $value->appointment_id; ?>" ><i class="fa fa-user-md"></i></a>
                                        <?php } else { ?>
                                        <a class="btn btn-xs btn-primary" data-original-title="View Prescription" target="_blank" href="<?php echo base_url();?>admin/Prescription_controller/my_prescription/<?php echo $value->appointment_id; ?>"><i class="fa fa-eye"></i></a>   
                                        <?php } ?> 
                                        <a class="btn btn-xs btn-success"  target="_blank" href="<?php echo base_url();?>admin/Basic_controller/my_appointment/<?php echo $value->appointment_id; ?>"><i class="fa fa-print"></i></a>
                                        <a class="btn btn-xs btn-info"  target="_blank" href="<?php echo base_url();?>History_controller/patient_history/<?php echo $value->patient_id; ?>"><i class="fa fa-history" aria-hidden="true"></i></a>
